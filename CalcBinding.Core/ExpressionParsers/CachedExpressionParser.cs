...
namespace CalcBinding.ExpressionParsers
{
    public sealed class CachedExpressionParser : IExpressionParser
    {
        ...
        private readonly Dictionary<ExpressionKey, WeakReference> _cachedExpressions = new Dictionary<ExpressionKey, WeakReference>();
        private readonly IExpressionParser _innerParser;
        ...
        private struct ExpressionKey : IEquatable<ExpressionKey>
        {
            ...
            private static readonly ParameterComparer _parameterComparer = new ParameterComparer();
        }
